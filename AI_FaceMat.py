...
# ==============================================================================
# ASSIMILATE SCRATCH REST API WRAPPER (SDK-BACKED)
# ==============================================================================
# Uses the official assimilate_client SDK classes:
#   - ProjectsApi  (/constructs, /shot, /groups, /projects)
#   - ApplicationApi  (/application/render, /application/player, /application/tools)
#
# API reference: docs/Assimilate-API-docs-examples/README.md
# ==============================================================================
